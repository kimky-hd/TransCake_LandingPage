<%@ page contentType="text/html;charset=UTF-8" language="java" %>
    <%@ page import="org.example.model.User" %>
        <% User user=(User) session.getAttribute("loggedInUser"); if (user==null) {
            response.sendRedirect("landingpage.jsp"); return; } String fullName=user.getFullName() !=null &&
            !user.getFullName().trim().isEmpty() ? user.getFullName() : "Người dùng" ; %>
            <!DOCTYPE html>
            <html lang="vi">
                    ...
                    <div
                        ...
                        <div id="passenger-view"
                            ...
                            <div class="flex items-center gap-4 mb-8">
                                <div class="relative">
                                    <svg class="w-14 h-14 text-slate-300 bg-slate-100 rounded-full border-[3px] border-white shadow-md"
